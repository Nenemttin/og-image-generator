...
/** Allowed query parameters for the OG edge generation route */
...
/** Input length constraints for DoS & memory exhaustion defense */
export const INPUT_LIMITS = {
  TITLE_MAX_LENGTH: 100,
  TAG_MAX_LENGTH: 30,
  DESCRIPTION_MAX_LENGTH: 200,
  THEME_MAX_LENGTH: 20,
  LICENSE_KEY_MAX_LENGTH: 100,
} as const;

/** Fallback defaults for URL query params */
...
/** Edge cache control response headers */
export const CACHE_CONTROL = {
  IMAGE: "public, max-age=86400, s-maxage=31536000, stale-while-revalidate=86400",
  REDIRECT: "public, max-age=86400, s-maxage=31536000",
} as const;
